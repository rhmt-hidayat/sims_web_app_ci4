                ...
                <form action="<?php echo base_url() . 'produk/update' . '/' . $produk['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-lg-12 col-md-8 col-sm-12">
                            ...
                            <div class="dropzone <?= isset(session()->getFlashdata('errors')['image']) ? 'is-invalid' : '' ?>" id="dropzone" value="<?= (old('image')) ? old('image') : ($produk['image']) ?>">
                                ...
                                <?php if ($produk['image']): ?>
                                    <img src="<?= base_url('uploads/' . $produk['image']) ?>" alt="Gambar" width="80px" class="img-thumbnail">
                                    <p>Gambar Lama</p>
                                <?php else: ?>
